...
public class TerminalFunctionsDemo {
	...
	// Terminal functions are used in the pipeline 
	// they trigger the execution of intermediate functions
	// they return a result which can be a value , collection or a void.
	...
	public static void main(String[] args) {
		...
		//reduce() - It is a terminal operation used to combine all elements of a stream into a single unit.
